...
import { KyberSwapProvider, SingleQuoteResult } from "@yasp/swap-providers";
...
export class KyberSwapSwapper extends SwapProvider {
  constructor(public kyberSwapSwapProvider: KyberSwapProvider) {
    super();
  }
  ...
  async swap(
    ...
    const swapTxPayload =
      await this.kyberSwapSwapProvider.createTransactionPayload(
        chain,
        quote,
        walletAddress
      );
